...
describe('sortData',()=>{
  it('retorna un arreglo de pokemons ordenado',()=>{
    expect(sortData(pokemons, "az")).toEqual(expect.arrayContaining(pSort));
  });
  it('retorna un arreglo de pokemons ordenado de manera inversa',()=>{
    expect(sortData(pokemons, "za")).toEqual(expect.arrayContaining(pSort));
  });
});
